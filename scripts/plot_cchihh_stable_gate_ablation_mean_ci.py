...
CONFIGS = [
    ("cfg1_stable_on_gate_on", "1) stable on, gate on", "#1f77b4"),
    ("cfg2_stable_off_gate_on", "2) stable off, gate on", "#ff7f0e"),
    ("cfg3_stable_on_gate_off", "3) stable on, gate off", "#2ca02c"),
    ("cfg4_stable_off_gate_off", "4) stable off, gate off", "#d62728"),
]
...
def main():
    ...
    g_ref = stats["cfg1_stable_on_gate_on"]["gens"]
    ...
    plot_series(
        ...
        [stats["cfg1_stable_on_gate_on"], stats["cfg2_stable_off_gate_on"]],
    )
    plot_series(
        out_dir / "cchihh_ablation_1_vs_3_mean_ci",
        "CCHIHH Ablation: 1 vs 3 (mean ± 95% CI)",
        [stats["cfg1_stable_on_gate_on"], stats["cfg3_stable_on_gate_off"]],
    )
    plot_series(
        out_dir / "cchihh_ablation_1_vs_4_mean_ci",
        "CCHIHH Ablation: 1 vs 4 (mean ± 95% CI)",
        [stats["cfg1_stable_on_gate_on"], stats["cfg4_stable_off_gate_off"]],
    )
    plot_series(
        out_dir / "cchihh_ablation_1_2_3_4_mean_ci",
        "CCHIHH Ablation: 1,2,3,4 (mean ± 95% CI)",
        [
            stats["cfg1_stable_on_gate_on"],
            stats["cfg2_stable_off_gate_on"],
            stats["cfg3_stable_on_gate_off"],
            stats["cfg4_stable_off_gate_off"],
        ],
    )
